...
Use this for `common/` work after `project/agent-workflow-and-module-map`. The module is shared CLJC used by frontend, backend, exporter, and file/library tooling; small behavior changes can affect multiple runtimes.
